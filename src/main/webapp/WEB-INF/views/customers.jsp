...
<body>
	<div class="container" id="main-menu">
		...
		<div id="content">
			<h3 style="  margin: 30px 0;">LIST OF CUSTOMER</h3>
			<c:forEach items="${customers}" var="customer">
			
				<div class="col-xs-12 col-sm-12 col-md-4 col-lg-4" style="padding: 40px;">
					<div class ="customer-image" >
						<a href="<c:url value="customer_${customer.customerId}.html"/>"><img src="assets/images/${customer.imagePath}"/></a>
					</div>
