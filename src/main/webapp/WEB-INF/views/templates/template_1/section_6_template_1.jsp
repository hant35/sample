		...
		<div class="col-xs-12 col-sm-12 col-md-10 col-lg-10">
				...
				<div class="col-xs-12 col-sm-12 col-md-8 col-lg-8">
					...
					<div class="row">
						<div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
                                                        <p><input id="all-target" type="checkbox" value="false"> All</p>
			...
			<div class="row">
				<div class="col-xs-12 col-sm-12 col-md-4 col-lg-4">
					...
					<div class="row">
						<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                                                        <p><input id="all-language" type="checkbox" value="false"> All</p>
				...
				<div class="col-xs-12 col-sm-12 col-md-4 col-lg-4">
					...
					<div class="row">
						<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                                                        <p><input id="all-age" type="checkbox" value="false"> All</p>
				...
				<div class="col-xs-12 col-sm-12 col-md-4 col-lg-4">
					...
					<div class="row">
						<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                                                        <p><input id="all-gender" type="checkbox" value="false"> All</p>
