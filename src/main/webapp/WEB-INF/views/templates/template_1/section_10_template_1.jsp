		...
		<div class="col-xs-12 col-sm-12 col-md-10 col-lg-10">
			<div class="row">
				<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
					<h1>Please choose the option(s) and adjust the budget accordingly.</h1>
				</div>
			</div>
			<div class="row">
				<div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
					...
					<div class="row">
						<table style="width:100%">
							...
							<tr  id="tr_panpages-option-a-input">
						...
						<p style="display: none;">Suggested advertising budget for your advertiser is <span id="Calculation-Code-L-OptionA" name="fields['total-campaign-budget']" style="font-weight: bold;"></span></p>
						<input id="budget-option-a" type="hidden" style="display: none;">
						<input id="total-google-budget" type="hidden" style="display: none;">
					</div>
				</div>
				<div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
					<div class="row">
					...
					<div class="row">
						...
						<p style="display: none;">Suggested advertising budget for your advertiser is <span id="Calculation-Code-L-OptionB" style="font-weight: bold;"></span></p>
						<input id="budget-option-b" type="hidden" style="display: none;">
					</div>
				</div>
			</div>
		</div>
